...
(async () => {
  try {
    ...
    const e = Math.floor(new Date('2026-07-06T20:59:59.000Z').getTime() / 1000);
    
    // Fetch ALL pages
    let allObjects = [];
    let page = 0;
    while (true) {
      const url = "https://api.azs-online.uz/api/events/deviceRefillEvents?dateStart=1783364400&dateEnd=1783450799&page=0&countOnPage=100";
